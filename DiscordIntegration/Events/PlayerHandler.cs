...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public async void OnDying(Exiled.Events.EventArgs.Player.DyingEventArgs ev)
        {
            ...
            if (Instance.Config.StaffOnlyEventsToLog.PlayerDying && ev.Player != null && (ev.Player == null || !Instance.Config.ShouldLogFriendlyFireKillsOnly || ev.Attacker.Role.Side == ev.Player.Role.Side))
